...
const CONFIG_COLUMNS =
  'provider, model, api_key, system_prompt, is_active, auto_reply_enabled, auto_reply_max_per_conversation, embeddings_api_key, owner_notification_phone'
...
export async function loadAiConfig(
  ...
  return {
    ...
    embeddingsApiKey,
    ownerNotificationPhone: row.owner_notification_phone,
  }
}
